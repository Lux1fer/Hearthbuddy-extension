...
TAG_CARD_SET = {
    ...
    TAG_CARD_SET_ENUM.CROSS_TIME:               "1957-穿越时间流",
}
...
#各文件路径
file_cardIDEnumPath = f"Routines/DefaultRoutine/Silverfish/ai/CardDB_cardIDEnum.cs"
file_cardNameCNPath = f"Routines/DefaultRoutine/Silverfish/ai/CardDB_cardNameCN.cs"
file_cardNameENPath = f"Routines/DefaultRoutine/Silverfish/ai/CardDB_cardNameEN.cs"
file_simOldRootPath = f"Routines/DefaultRoutine/Silverfish/cards/"
file_simNewRootPath = f"Routines/DefaultRoutine/Silverfish/cardsNew/"
file_cardDefsPath = f"Routines/DefaultRoutine/Silverfish/data/CardDefs.xml"
        ...
        if cardSet not in TAG_CARD_SET:
            ...
            if cardType not in TAG_CARDTYPE or \
                ...
                if cardType not in TAG_CARDTYPE:
                    print(f"No Find cardType:{cardType}")
                if cardClass not in TAG_CLASS:
                    print(f"No Find cardClass")
            else:
